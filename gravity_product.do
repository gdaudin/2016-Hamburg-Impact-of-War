...
replace classification_hamburg_large="other" if classification_hamburg_large!="Café" & classification_hamburg_large!="Eau ; de vie" & classification_hamburg_large!="Sucre ; cru blanc ; du Brésil" & classification_hamburg_large!="Indigo" & classification_hamburg_large!="Vin ; de France" 
...
foreach var of varlist class_1-class_6{
...
***regress with time trend, fe and war dummies
reg lnvalue i.pays year_pays_1-year_pays_13 war neutral allies, robust 

***regress with time trend, fe and war dummies with time trends
reg lnvalue i.pays year_pays_1-year_pays_13 war neutral allies year_war year_allies year_neutral, robust 
