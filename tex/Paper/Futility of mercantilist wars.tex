...
\source{French trade up to 1821 from TOFLIT18 database. French trade 1822-1840: Federico \& Tena. England/British trade to 1800 : Deane \& Cole. UK trade from 1801 to 1840 : Federico \& Tena}
\label{FrBritTrade}
\end{figure}

Looking at peace-time trends, it is clear that French trade, despite big war shocks, was resilient and was not moved out of its pre-1744 trend (Figure \ref{FrPeaceTrade}). Things changed after 1815.


\begin{figure}
\caption{Peace time trends of total French trade}
\includegraphics[scale=.6]{Peace-time trends of French trade.png}
\source{French trade up to 1821 from TOFLIT18 database. French trade 1822-1840: Federico \& Tena}
\label{FrPeaceTrade}
\end{figure}
