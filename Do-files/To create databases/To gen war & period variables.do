...
replace period_str ="War 1756-1763" if year   >= 1756 & year <=1762
replace period_str ="Peace 1764-1777" if year >= 1763 & year <=1777
...
////Peace was signed in early February 1763, so we treat 1763 as a peace year
