...
replace each_war_status="War adversary" ///
...
replace each_war_status="War neutral" if pays_grouping=="Hollande" & year==`i'
replace each_war_status="War neutral" if pays_grouping=="Levant" & year==`i'
replace each_war_status="War neutral" if pays_grouping=="Nord" & year==`i'
replace each_war_status="War neutral" if pays_grouping=="Suisse" & year==`i'
replace each_war_status="War neutral" if pays_grouping=="Portugal" & year==`i'
replace each_war_status="War neutral" if pays_grouping=="Angleterre" & year==`i'
replace each_war_status="War neutral" if pays_grouping=="Italie" & year==`i'
...
foreach i of num 1733/1738{
replace each_war_status="War allied" if ///
	each_war_status!="War neutral" & ///
	each_war_status!="War adversary" & year==`i'
...
foreach i of num 1740/1743{
replace each_war_status="War allied" if each_war_status!="War neutral" ///
	& each_war_status!="War adversary" & year==`i'
replace all_war_status="Allied" if all_war_status!="Adversary" ///
	& all_war_status!="Neutral" & year==`i'
}
...
replace each_war_status="War adversary" if ///
...
replace each_war_status="War neutral" if ///
	pays_grouping=="Flandre et autres états de l'Empereur" & year==`i'
replace each_war_status="War neutral" if pays_grouping=="Italie" & year==`i'
replace each_war_status="War neutral" if pays_grouping=="Levant" & year==`i'
replace each_war_status="War neutral" if pays_grouping=="Nord" & year==`i'
...
replace each_war_status="Cont_blockade adversary" if ///
	pays_grouping=="Angleterre" & year==`i'
replace each_war_status="Cont_blockade adversary" if ///
	pays_grouping=="Flandre et autres états de l'Empereur" & year==`i'
replace each_war_status="Cont_blockade adversary" if ///
...
replace each_war_status="Cont_blockade adversary" if pays_grouping=="Italie" & year==`i'
...
replace each_war_status="Cont_blockade neutral" if pays_grouping=="Levant" & year==`i'
replace each_war_status="Cont_blockade neutral" if pays_grouping=="Nord" & year==`i'
replace each_war_status="Cont_blockade neutral" if pays_grouping=="Suisse" & year==`i'
...
foreach i of num 1792/1795{
replace each_war_status="Cont_blockade allied" if each_war_status!="Cont_blockade neutral" ///
	& each_war_status!="Cont_blockade adversary" & year==`i'
replace all_war_status="Allied" if all_war_status!="Adversary" & ///
	all_war_status!="Neutral" & year==`i'
}
...
replace each_war_status="Cont_blockade neutral" if pays_grouping=="Levant" & year==`i'
replace each_war_status="Cont_blockade neutral" if pays_grouping=="Nord" & year==`i'
replace each_war_status="Cont_blockade neutral" if ///
	pays_grouping=="Allemagne et Pologne (par terre)" & year==`i'
...
replace each_war_status="Cont_blockade allied" if year==`i'
...
replace each_war_status="Cont_blockade allied" if ///
...
replace each_war_status="Cont_blockade adversary" if pays_grouping=="Portugal" & year==`i'
replace all_war_status="Adversary" if ///
	pays_grouping=="Portugal" & year==`i'
}
...
replace each_war_status="Cont_blockade adversary" if pays_grouping=="Espagne" & year==`i'
replace all_war_status="Adversary" if pays_grouping=="Espagne" & year==`i'
}
