...
graph twoway (area wara year, color(gs14%30)) ///
			 ...
			 (area war3 year, color(gs9%30)) (area war4 year, color(gs4%30)) ///
			 (area war5 year, color(gs4%30))  ///
...
graph twoway (area wara year, color(gs14%30)) ///
			 ...
			 (area war3 year, color(gs9%30)) (area war4 year, color(gs4%30)) ///
			 (area war5 year, color(gs4%30))  ///
			 (line France_vs_GB year,  cmissing(n)) ///
			 (line ally_vs_foe year, lpattern(dot) cmissing(n)) ///
