...
replace each_status=0 if each_status_==.
...
replace all_status=0 if all_status_==.
replace all_status_class=0 if all_status_class==.


****regress

poisson value i.pays_class year_pays1-year_pays12 year_class1-year_class5 i.all_status_class

poisson value i.pays_class year_pays1-year_pays12 year_class1-year_class5 i.each_status_class
