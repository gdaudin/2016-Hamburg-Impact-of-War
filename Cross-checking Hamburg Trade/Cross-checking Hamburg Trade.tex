...
\title{Cross-checking sources on eighteenth century trade between France and Hamburg\thanks{We are grateful to ... Ajexandre Aubourg...Ulrich Pfister... This work was funded by the OFCE and the Agence Nationale de la Recherche (Projet TOFLIT18, ANR-13-BSH1-0005)}}
...
As underlined in \cite{charles2015eighteenth}, these statistics are only being systematically collected now because of the practical difficulties linked with the raw amount of data that were difficult to solve before IT ressources became much more affordable.
Ancient arguments about the reliability of the data resurface at this occasion.
In France, for example, Bertrand Gille asserted long ago that while external trade statistics are among “the most consistent economic series”, “the numbers produced are often fanciful” and “difficult to match” from one document to another (\cite{gille_les_1964} quoted in  \cite{charles2015eighteenth}).
...
This is the aim of this paper. The digitization of eighteenth century trade data sources for Hamburg and France make cross-checking possible. It follows similar exercices between French and Sound Toll registers sources \cite{charles_cross-checking_2018} and the sources from Austrian Netherlands that have been recently digitized \cite{charles_comparing_2016. We have encouraging results.
