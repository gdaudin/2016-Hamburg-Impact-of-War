...
\begin{figure}
\centering
\caption{American Independence War and Peace 1784-1792}
\label{post_revolutionary_composition}
\includegraphics[scale=.63]{post_independence_composition_I}
\includegraphics[scale=.63]{post_independence_composition_X}
\vspace{0.7cm}
\includegraphics[scale=.63]{post_independence_distribution_I}
\includegraphics[scale=.63]{post_independence_distribution_X}
\end{figure}

\begin{figure}
\centering
\caption{Peace 1784-1792 and Revolutionary War}
...
\includegraphics[scale=.63]{revolutionary_blockade_composition_I}
\includegraphics[scale=.63]{revolutionary_blockade_composition_X}
\vspace{0.7cm}
\includegraphics[scale=.63]{revolutionary_blockade_distribution_I}
\includegraphics[scale=.63]{revolutionary_blockade_distribution_X}
\end{figure}
