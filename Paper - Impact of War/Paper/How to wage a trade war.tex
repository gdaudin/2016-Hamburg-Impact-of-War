...
\cite{Levy2004} find a mild and temporary impact of war on trade with adversary country, using a panel of dyads between 1870 and 1992.
\cite{Blomberg2006} shows large and positive impact of all kinds of conflicts on trade. 
\cite{Anderton2001} distinguish between conflicts with major and minor power and observe significant pre and post war effects only in the former case.
Along similar lines, \cite{Rahman2010} shows that conflicts with a major naval power are particularly disruptive.
\cite{Glaser2016} shows that even the naval arm race by itself at the end of the nineteenth century (1870-1914) was damaged commercial interests and lowered trade potential around the world.
\cite{Glick2010} venture to quantify the effects of the two World Wars not just in terms forgone trade but also lost human capital.
Their conclusion is that the negative effects extend to neutral countries and can have persisted up to ten years.  
