...
Finally, for 1816-1825, we use the official publication named "Compte Rendu par le Ministre Secrétaire d’État des Finances pour l’année ...".
We try to determine what has been actually expended each year rather than each year’s budget, as before the reform of 1822 these were not the same thing (see {Kott2019}).
