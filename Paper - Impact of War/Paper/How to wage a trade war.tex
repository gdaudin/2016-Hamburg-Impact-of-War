...
The numbers given by Starkey and Hillman for privateers’ prizes are not the same, but the correlation between the two series is 0.8 (excluding peace years when both are at 0).
We use Hillman’s serie as it covers a longuer time span and allows to extrapolate prizes’ nationalities.
