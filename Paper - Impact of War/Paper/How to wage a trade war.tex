...
Thank to data provided by Henning Hillmann (coming mainly from records at the PRO High Court of the Admiralty archives and underlying \cite{Hillmann2011}), we can compute an approximation of the number and the nationality of prizes captured by privateers up to 1809 (see Figure \ref{Prizes})
...
\begin{center}
	\begin{figure}[H]
		...
		\source{\cite{Starkey1990} and data provided by Hennening Hillmann, underlying \cite{Hillmann2011}}
	\end{figure}
\end{center}
...
There are no time serie available on the prizes captured by the Royal Navy during that period.
We have three reasons to believe that the pressure on French trade exerciced by the Royal Navy was important.
First, up to 1800 we have data on prize goods imported in Great Britain (see Figure \ref{Prize goods imports})). Presumably, the pressure on French trade was very important, especially after 1809 as the Blockade was in place.
