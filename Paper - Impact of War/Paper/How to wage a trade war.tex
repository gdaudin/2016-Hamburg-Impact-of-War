...
The importance of privateers depended on the attractiveness of alternative options \cite[p. 673]{Villiers2002,Hillmann2011}, \todo[inline, color= blue!40]{Maybe a word of example as to what options?} but their impact on the French merchant fleet was especially strong during the War of American Independence \cite[table 1]{Hillmann2011}.
\todo[inline, color= blue!40]{Maybe some numbers as an example?}
Clearly merchants were reticent to trade in these settings. As a consequence, in war time, insurance became a widespread practice. Forgone profits however could not be insured \cite[p. 160]{Ducoin1993}, \cite{Villiers2002}, \cite[p. 690-720]{Butel1973} and sometimes insurance rates were increasing so much that shipping was discouraged altogether. On top of lost cargoes and lost profits, captivity for the sailors also represented a problem. Even though they were liberated at peace time (and sometime earlier through exchange of prisoners), mortality in British prisons was such that their capture represented a long-term loss for the French navy \cite{LeGoff1998}. \todo[inline, color = blue!40]{To the navy or to the merchant fleet in general?}
...
\section{Regression}
\begin{table}[h!]
	\caption{Regression the loss functions on the log of the sectorial shares of exports}
	\input{Individual_reg_product_sitc_simplEN_Exports.tex}
\end{table}

\begin{table}
	\caption{Regression the loss functions on the log of the sectorial shares of imports}
	\input{Individual_reg_product_sitc_simplEN_Imports.tex}
\end{table}
