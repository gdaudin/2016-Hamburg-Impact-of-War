...
\todo[inline, color =YellowGreen]{I am sorry, my questions was how many "directions" are using in the regression? all of them or just the main ones? I wanted to make a clarifying table -- 18 see table 18}
...
\todo[inline, color = YellowGreen]{What are the weights we used here? I cant remember -- just remove the weights GD ?}
