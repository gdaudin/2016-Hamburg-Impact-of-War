...
\begin{figure}[h!]
\caption{Annual and Mean Loss Function}
\label{annual_loss_function}
\centering
\includegraphics[scale=.8]{mean_annual_loss}
\end{figure}

\begin{figure}[h!]
\caption{GB Annual and Mean Loss Function}
...
\centering
\includegraphics[scale=.8]{naval_supremacy_ratio}
\end{figure}
\end{center}
