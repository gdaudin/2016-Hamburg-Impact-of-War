...
\subsection{Explained variable: a loss function} 
...
%\end{figure}
%
%\section{Changing composition of trade} 
%\begin{table}[h!]
%\centering
...
%
%\begin{table}[h!]
%	\caption{Regression the loss functions on the log of the sectoral shares of exports}
%	\input{Individual_reg_product_sitc_simplEN_Exports.tex}
%\end{table}
%
%\begin{table}
%	\caption{Regression the loss funttions on the log of the sectoral shares of imports}
