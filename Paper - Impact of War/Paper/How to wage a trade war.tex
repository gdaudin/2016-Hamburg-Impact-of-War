...
Another measure of the pressure British exercised on French trade comes from English and British trade statistics that measure prize goods imported in Great Britain up to 1800 \citep{Ashton1960} (see Figure \ref{Prize goods imports}).
\todo[inline, color = YellowGreen]{Conclude section on predation on french shipping}
...
Britain responded to this policy with a related Order in Council, which required that neutral vessels call at a British port before proceeding to the continent. This started a war that engulfed the whole of Europe and the only remaining neutrals trading region was the \textit{Levant} (see figure \ref{fig:number_of_protagonist} in the appendix). 
It has to be noted here that, differently from the firs half of the century, the United States had become a new powerful independent actor in mediating between Great Britain and Spanish America \citep{Cuenca-Esteban2014}. Considering the size and dynamism of their economy, they were not as easy to dismiss as small neutral trading nations when peace returned. Therefore, when the threat on trade by both France and Britain loomed, they attempted to fight back. They first enacted, in 1807, an Embargo Act directed against trade with both France and Britain, which was followed by the Non-Intercourse Act of 1809, and finally, after failure of both provisions, by a war against Britain.
...
\todo[inline, color = YellowGreen]{Conclude section on predation on neutral } 
...
\todo[inline, color = YellowGreen]{Make a unique section for the Regression }
...
These adaptations were difficult to reveres after the wars and French trade was durably locked into a less dynamic structure.
...
Hence a decline of 100 livres tournois in French trade induced a loss of 14 livres tournois for French GDP (14=35-21). 
...
Finally, for 1816-1825, we use the official publication named ``Compte Rendu par le Ministre Secrétaire d’État des Finances pour l’année ...'' \todo[inline, color = blue!40]{cite 1817,1818,1819... }
