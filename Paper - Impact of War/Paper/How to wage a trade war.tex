...
Data on the value of privateers’ prizes come from \cite{Hillmann2011}.
For post-1793 Royal Navy prizes, we use the data from \cite{Benjamin2009, figure 2}, based on \cite{Hill1998}, reflated using the silver value of the pound sterling.
We have rescaled the graph to get a total of 30.8 million pounds. 
These data include warship prizes, which are more expensive than trade ships.
We have no basis to adjust this number and thus we do no try.
