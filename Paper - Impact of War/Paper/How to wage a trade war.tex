...
There is a large literature on the subject, but it is short of statistics.
...
This is a good measure of the pressure exerced on  trade, as taking ransoms was becoming illegal during the century (see\cite{Hillmann2011}, p. 734 ).
Thank to data provided by Henning Hillmann (coming mainly from records at the PRO High Court of the Admiralty archives and underlying \cite{Hillmann2011}), we can have an approximation of the nationality of the prizes captured by privateers up to 1809.
Privateering activity became marginal during the Revolutionaly  
However, equivalent data are not available for the Royal Navy.
\cite{Hillmann2011} compute that British privateers intercepted about 15 percent of all French merchant ships during periods of war and 4 per cent of overseas trade during the War of Austrian Succession, the Seven Years War and the War of American Independence. 
