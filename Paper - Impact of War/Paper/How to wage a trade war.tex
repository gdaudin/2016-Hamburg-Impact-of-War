...
As explained more in detail in section \ref{sec:empirical_analysis} we construct a loss function to observe the trend of French losses throughout the period in analysis. \todo[inline, color = blue!40]{I can't remember how you were suggesting to introduce this part}
...
the pressure maritime war exerted on trade. By pooling together different sources we aim to provide here an idea of the size of this effect. \todo[inline, color = blue!40]{"as British state limited its alternative, ransoming more and more drastically from 1744 (see \cite{Hillmann2011}, p. 734 )": I dont understand this sentence}
...
\todo[inline, color = blue!40]{I think we need to provide a little bit more of background here or before. What is this story that it was up to he High Court of the Admiralty to declare prizes legal? there is no mention of this before}
\cite{Benjamin2009} provides a chronology of prizes taken by the Royal Navy in the sample first gathered by \cite{Hill1998}.
Figure \ref{Prizes} represents all the above mentioned data together. We see here that the share of privateering activity was very significant until Seven Years War but became marginal during the Revolutionary \& Napoleonic Wars. This can be explained by the development of other profit alternatives. \todo[inline, color = blue!40]{Like what?} 
...
\todo[inline, color = blue!40]{From figure Prizes I dont see it declining except that at the very end. I assumed you referred to that }
...
\todo[inline, color = blue!40]{What's the source for this graph? is it still the same three above? What is the takeaway from this? }
...
We see here that the most favourable war for France, its allies and neutral countries was the Seven Years War, when the number of neutral warships or ships on the French side was more than twice as much that of Britain and its allies. This number is probably inflated by the increase in navy expenditure and size of Sweden and Russia, \todo[inline, color = blue!40]{I remember Sweden and Russia have a bigger navy in this period so I just assumed they increased expenditure. Is this really true? If so it could be worthwhile mentioning a source!} even though there was no common naval action with France. Nonetheless, the ratio without the neutrals is still the highest throughout the period in analysis, suggesting a nearly one to one relation between the two navy sizes. 
During the American Revolutionary War and the Napoleonic Wars the ratio is lower, even though there are some spikes, which bring it again close to one. \todo[inline, color = blue!40]{Do we know why?}
The least favourable of all wars was the Austrian Succession War, which should not be surprising as the mercantilist war had not yet started. \todo[inline, color = blue!40]{Is this true?}
...
\todo[inline, color = blue!40]{Why do we care of its role as mediation between GB and Spanish America? I would remove the last bit of sentence but just in case..}
...
\todo[inline, color = blue!40]{do you mean here that in 1820 it was at level 10m while it was 40m in 1807?}
