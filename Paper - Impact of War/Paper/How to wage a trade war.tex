...
Indeed, Alfred T. Mahan, a hugely influencial naval thinker, argued that the nineteenth-century British preeminence was the product of naval dominance beginning in the seventeeth century \citep{Mahan2004,Mahan2016,Mahan2016a}.
Attacking and protecting trade are often major military activities, such as during US Civil War, World War I and World War II (both in the Atlantic and the Pacific).
Belligerents routinely succeed in reducing each other’s trade.
Sometimes, attacks on trade arguably achieve militarly decisive results, such as the blockade of Japanese Home Islands during World War II, sometimes less so, such as the blockades of Germany during World War I and World War II or the submarine campaigns by Germany.
Long term changes in relative economic fortunes are more elusive.
...
Yet Britain seems to have achieved this very goal in the seventeenth century versus the Dutch and in the long eighteenth century versus the French.
These feats have inspired generations of naval strategists such as Mahan.
This paper examines the mecanisms explaining the success of the British war on French trade from 1744 to 1815.
 
This is an important question.
During Trump’s precidency, trade wars have come again at the forefront.
...
The latter part of the conflict between France and Britain was central to deglobalisation from 1790 to the 1830s (\cite{ORourke2006},\cite[table 4.5]{ORourke2010}): the consequences of trade wars can be far-reaching and it is important to understand them better.
...
Certainly, for book-writing eighteenth-century Britons, the war with France seemed to be a more important subect than antyhing linked the Industrial Revolution (figure \ref{Ngram}).
...
War has many causes.
Still, especially after firm establishment of the Hanoverian dynasty of the United Kingdom’s throne, mercantile rivalry was an important motivation of French wars \citep{Wallerstein1980, Tracy1991, Davis2006, Crouzet2008}; each nation was jealous of the other's commercial success; the British believed war was a good way to curtail French trade, despite the huge ressources it required \citep{Baugh1965, Neal1977, Brewer2002}.
...
But, before 1815, it is not obvious that French peacetime trade was much affected by British efforts.
Paradoxically, French trade, despite a visible decrease in wartime, was recovering quite fast in peace time, at least until the end of the eighteenth century.
War by itself was not enough to curtail French trade.
By studying more precisely how the British war on French trade was waged, we can understand its mecanisms and what explained its eventual success.
We aim to show it was a difficult and costly endeavour; the key factor was not to reduce the level of trade, but to force its structural change; it succeeded partly because the French cooperated through their own attempt at changing the structure of their trade, notably during the period of the Continental System.
...
\label{sec:wartime_strategies}
 \todo[inline, color = NavyBlue]{Mahan believed in decisive battles and Blockade, not in the attack of ennemy’s trade. The \textit{Jeune école} believed attack on trade could be efficient (e.g. U-boats)}
...
We aim to identify the channels used by the British to disrupt French trade and disentangle their success. In order to do so, we create a quantitative measure, to assess their efficacy and compare it more easily to the loss function. \todo[inline, color = NavyBlue]{Better? More understandable?} 
...
We examine in detail the following four possible channels: 1) ship building and alliance making 2) capture of colonies 3) predation on shipping 4) predation on neutral.  
 \todo[inline, color = NavyBlue]{I think capture of colonies should go first as it the first comment everybody makes? What do you think? Not a strong position on this}
...
To quantify the loss of colonies, we proxy the importance of each territory by its share in French colonial imports in 1788, when French empire was at its maximum (neglecting Canada which was not a major source of trade products).
The variable is set at 1 in 1788 and gets reduced by an amount proportional to the share of trade whenever a colony is lost.
...
According to this measure, the colonial loss of the Seven Years War were minimal (Canada was not an important trade partner for France).
In contrast, a large part of the French Empire was gradually lost in the Revolutionary \& Napoleonic Wars.

We argue that, despite the weight of colony loss for French trade, and Saint Domingue in particular, this was not enough to make a successful trade war. 
As for the case of naval supremacy, we compute a correlation between the loss function and the measure for colonial empire. Considering only war years, the correlation is negative and significant, around 30\%. If we consider cumulative discounted losses, it is still significant but it drops to below 4\%. As a consequence we conclude that, as far as it is possible to quantify, colony loss explains only partly the fluctuations in the loss function, and also other factors are at play. 
 \todo[inline, color = NavyBlue]{Good?}
