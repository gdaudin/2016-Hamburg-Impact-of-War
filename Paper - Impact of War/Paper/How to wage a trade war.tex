...
In this section we study the link between this loss function and the tools used by the British in their war on French tade.
...
\todo[inline, color = NavyBlue]{Better? More understandable?} 
\todo[inline, color = YellowGreen]{I do not think we need the additional sentence: it is a bit convoluted.}
...
\todo[inline, color = YellowGreen]{I think it is important to start from the inputs and move to the outputs. Maybe Ships / Colonies / Neutral policy / Predation ?}
