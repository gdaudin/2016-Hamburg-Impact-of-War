...
The Anglo-French War in the eighteenth century was destructive for trade.
...
Merchant losses were mitigated by the widespread practice of insurance \cite[p. 160]{Ducoin1993} \cite{Villiers2002}[p. 690-720]\cite{Butel1973}.
The expected profit loss could no be insured though. In the French case, it  happened that insurance rates increased so much that it discouraged shipping completely.
...
They came back at peace time, but mortality in British prisons was such that their capture represented a long-term loss for the French navy.\cite{LeGoff1998}
