...
\todo[inline, color = RoyalBlue]{Axis labels are unclear. Number of prizes is for the histogram and the share is for the line? I think it's quite confusing, I would split it in two separate graphs. Also because the share of non French prizes I think would better suit the next section!}
...
\todo[inline, color = RoyalBlue]{A separate graph with share of non French prizes could be more relevant here}
...
Nonetheless, Ancien Régime France remained active at protecting the rights of neutral shipping, at least until the end of the eighteenth century, as it saw it as a means to continue its trade during war years \cite[p. 129]{Schnakenbourg2013}. This came to the extent that in 1784, France gave the West Indies island of St. Barthelemy to Sweden partly to encourage neutral trade during wars \cite[p. 326]{Schnakenbourg2013}.
However this attitude changed during the Revolutionary \& Napoleonic wars. In 1793, with the outburst of the French Revolution and, subsequently, the Revolutionary Wars, most British goods were prohibited in France.
\todo[inline, color = RoyalBlue]{What was the turning point here, that made French also impeding neutral trade? any source?}
...
A year later, Denmark and Sweden attempted again to protect their rights by creating a \textit{Second League of Armed Neutrality}, which was joined by Russia and Prussia in 1800.
...
The situation became no better in the subsequent years, when in 1806 Napoleon enacted the Berlin decree, which provided the basic structure of the Continental System.
...
Britain responded to this policy with a related Order in Council, which required that neutral vessels call at a British port before proceeding to the continent. This clearly created an unsustainable situation where all countries were barred from trading with either French or Britain and a war started that engulfed the whole of Europe (see figure \ref{fig:number_of_protagonist}). 
It has to be noted here that, differently from the firs half of the century, the United States had become a new powerful independent actor in international trade \citep{Cuenca-Esteban2014}. Considering the size and dynamism of their economy, they were not as easy to dismiss as small neutral trading nations when peace returned. Therefore, when the threat on trade by both France and Britain loomed, they attempted to fight back. They first enacted, in 1807, an Embargo Act directed against trade with both France and Britain, which was followed by the Non-Intercourse Act of 1809, and finally, after failure of both provisions, by a war against Britain. 
...
\todo[inline, color = RoyalBlue]{I moved the MANOVA section in the appendix... do we agree?}
...
\todo[inline, color = RoyalBlue]{Is this true for ports?}
...
\todo[inline, color=RoyalBlue]{What is the result of the joint significance test?}
...
\newgeometry{left=1cm,right=0.3cm,top=.8in,bottom=.8in,}
...
\begin{figure}[h!]
	\caption{Share of French trade conducted by sea}label\label{share_by_sea}
	\centering
	\includegraphics[scale=.2]{share_by_sea}
	\begin{minipage}{18cm}
	\begin{flushleft}
	\fontsmall
...
\source{For privateers and before 1785 for the Royal Navy, \cite{Starkey1990} and \cite{Hillmann2011}. For post-1793 Royal Navy prizes, we use the data on the value of Navy Prizes from \cite{Benjamin2009}, based on \cite{Hill1998}. The peak in Dutch prices in 1781 is omitted in this figure for readability. \todo[inline, color = RoyalBlue]{Why was there the peak?? I cant remember anymore. Also what is the y axis here?}}
\end{minipage}
\end{figure}
...
Finally, for 1816-1825, we use the official publication named ``Compte Rendu par le Ministre Secrétaire d’État des Finances pour l’année ...'' \todo[inline, color = RoyalBlue]{cite 1817,1818,1819... }
