...
Figure \ref{Number of protagonists} sums up the data by showing the number of French allies, foes and neutral for each war year of interest. \\
\begin{center}
\begin{figure}[H]
\caption{Number of protagonists}
\label{Number_of_protagonists}
\centering
\includegraphics[scale=.51]{Number of protagonists.pdf}
\end{figure}
\end{center}
...
Figure \ref{loss_by_war_status_XI} is constructed by computing the mean country-specific trade loss function by trading zone. The trade loss function has been computed based on all preceding peace periods.
...
\begin{figure}[H]
\centering
\caption{Tade loss by war status}
