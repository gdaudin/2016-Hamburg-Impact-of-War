...
The numbre of privateer outfitting for 1793-1801 comes from \cite[appendix I]{Acerra1988}.
They atttribute it to \cite{Crowhurst1989}, but the numbers are actually different.
...
This allows us to compute nominal returns for 1793, 1796-1801.
In 1794 and 1795, privateering was illegal.
We assume all prizes reported by Norman for these years were captured by the French Navy and that the real value of prize was the mean of 1793 and 1796-1801.
We use the same methode to compute the total value of prizes from 1803 to 1814.
Again, we assume Navy’s share of prize is 14\% (=16\%/(1+16\%) and privateers’ profitablity is 43\% to apportionate outfittings and captures. 
